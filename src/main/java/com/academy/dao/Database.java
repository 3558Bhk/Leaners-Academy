...
public class Database implements AutoCloseable {
    ...
    public static Connection getConnection() {
        ...
        try {
            ...
            final String url = prop.getProperty("jdbc:mysql:localhost:3306/db6");

            final String username = prop.getProperty("root");

            final String pass = prop.getProperty("Bhk@3558");
